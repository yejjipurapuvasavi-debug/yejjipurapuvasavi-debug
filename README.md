...
I'm a Computer Science Engineering student passionate about **Artificial Intelligence, Generative AI, Web Development, and Problem Solving**.

🚀 Currently building **Nexora AI — AI Study Assistant**

🌱 Currently learning **Python, Git & GitHub, AI/ML and Cloud Technologies**
...
```text
Python → Problem Solving → Git/GitHub → AI/ML → Generative AI → Cloud

## 🤝 Let's Connect

💼 [LinkedIn](https://www.linkedin.com/in/vasavi-yejjipurapu-3b9b61397)

📧 [Email](mailto:yejjipurapuvasavi@gmail.com)
